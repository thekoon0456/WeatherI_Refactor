...
struct WeeklyWeatherConst {
    ...
    static let gangwonWest = ["철원군", "화천군", "양구군", "인제군", "춘천시", "홍천군", "횡성군", "원주시", "평창군", "영월군", "정선군", "이천군", "판교군", "평강군", "세포군", "김화군", "창도군", "회양군", "금강군"]
    static let gangwonEast = ["강릉시", "삼척시", "동해시", "태백시", "속초시", "양양군", "고성군", "통천군"]
